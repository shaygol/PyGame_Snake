...
def get_rand_color():
    ...
    rand_index = random.randint(0, len(colors_lst))
    rand_color_name = colors_lst[rand_index]
    return colors[rand_color_name], rand_color_name

# adsasd = {val for (key, val) in colors.items()}
